...
import { cancelarCompraMembresia, cancelarCompraProductos, comprarMembresia, comprarProductos, comprarVisitas, obtenerVentasMembresias, obtenerVentasProductos, obtenerVentasVisitas, renovarMembresia } from "../controllers/shoppingController.js";

const router = express.Router();

router.get("/ventas-productos",obtenerVentasProductos);
router.get("/ventas-membresias",obtenerVentasMembresias);
router.get("/ventas-visitas",obtenerVentasVisitas);
