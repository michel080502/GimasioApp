...
const MenuExport = ({onDownload, onSendReport}) => {
  return (
    <div className="absolute mt-28 bg-white border border-gray-300 rounded shadow-lg w-48 z-10 animate-fadeIn">
              <div className="flex flex-col divide-gray-400 text-base">
                <button
